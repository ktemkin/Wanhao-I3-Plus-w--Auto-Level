...
// #define RAMPS_V_1_0
  ...
  #define LARGE_FLASH true
    ...
    #define X_STEP_PIN         61//54
    #define X_DIR_PIN          62//55
    #define X_ENABLE_PIN       60//38
    #define X_MIN_PIN          54//3
    #define X_MAX_PIN           2

    #define Y_STEP_PIN         64//60
    #define Y_DIR_PIN          65//61
    #define Y_ENABLE_PIN       63//56
    #define Y_MIN_PIN          24//14
    #define Y_MAX_PIN          15

    #define Z_STEP_PIN         67//46
    #define Z_DIR_PIN          69//48
    #define Z_ENABLE_PIN       66//62
    #define Z_MIN_PIN          23//18
    #define Z_MAX_PIN          19
...
//    #define HEATER_1_PIN       -1
  ...
  #define TEMP_0_PIN         1//13   // ANALOG NUMBERING
  #define TEMP_1_PIN         14//15   // ANALOG NUMBERING
  #if MOTHERBOARD == 68
    ...
    #else
      #define HEATER_BED_PIN     3//22//8    // BED
    #endif
  #endif
    ...
    #define BEEPER 33
      ...
      #define LCD_PINS_D7 29
        ...
        #define SDCARDDETECT 49
         ...
         #define DOGLCD_A0  44
         #define DOGLCD_CS  66
         #define LCD_PIN_BL	25	// backlight LED on A11/D65
         #define SDSS   53
