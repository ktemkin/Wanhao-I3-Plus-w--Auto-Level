...
#define ENABLE_AUTO_BED_LEVELING // Delete the comment to enable (remove // at the start of the line)
  ...
  #define XY_TRAVEL_SPEED 3600         // X and Y axis travel speed between probes, in mm/min
...
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,100,407,96}  // default steps per unit for Ultimaker
#define DEFAULT_AXIS_STEPS_PER_UNIT   {81,81,400.5,94.3}  //���
#define DEFAULT_MAX_FEEDRATE          {450, 450, 5, 25}    // (mm/sec)
...
// The RepRapDiscount FULL GRAPHIC Smart Controller (quadratic white PCB) 12864
